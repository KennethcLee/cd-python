...
mary.displayUserBalance()
joe.displayUserBalance()
peter.make_deposit(40)
peter.make_deposit(10)
peter.make_deposit(33)
peter.make_withdrawal(50)

peter.displayUserBalance()
mary.displayUserBalance()
joe.displayUserBalance()
mary.make_deposit(32)
mary.make_deposit(49)
mary.make_withdrawal(11)
mary.make_withdrawal(28)

peter.displayUserBalance()
mary.displayUserBalance()
joe.displayUserBalance()
joe.make_deposit(145)
joe.make_withdrawal(31)
joe.make_withdrawal(59)
joe.make_withdrawal(12)
